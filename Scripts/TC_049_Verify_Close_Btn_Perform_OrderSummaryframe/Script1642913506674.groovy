...
WebUI.click(findTestObject('checkout/Order_Summary/Close'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('HomePage/BuyNow_Button'), 0)
