...
phone_shippingdetails = WebUI.getText(findTestObject('checkout/Order_Summary/Shipping_details/phone'))

System.out.println(phone_shippingdetails)
...
WebUI.verifyEqual(input_phone, phone_shippingdetails)
