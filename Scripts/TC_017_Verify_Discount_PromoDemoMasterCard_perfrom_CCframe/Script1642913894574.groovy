...
WebUI.click(findTestObject('checkout/Credit_Debit_card/promo/promo_demo_mastercard'))

discount = WebUI.getText(findTestObject('checkout/Credit_Debit_card/promo/master_card'))
