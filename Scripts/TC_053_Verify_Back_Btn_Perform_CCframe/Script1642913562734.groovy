...
WebUI.click(findTestObject('checkout/Credit_Debit_card/back_button'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('checkout/Select_payment/Select_Payment'), 0)
