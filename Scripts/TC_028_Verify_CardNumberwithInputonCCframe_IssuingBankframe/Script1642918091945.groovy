...
WebUI.setText(findTestObject('checkout/Credit_Debit_card/Card_number'), findTestData('Data_Input_Positive_Case').getValue(
        2, 12))

WebUI.setText(findTestObject('checkout/Credit_Debit_card/expired_date'), findTestData('Data_Input_Positive_Case').getValue(
        2, 13))

WebUI.setText(findTestObject('checkout/Credit_Debit_card/cvv'), findTestData('Data_Input_Positive_Case').getValue(2, 14))

input_card_number = WebUI.getAttribute(findTestObject('checkout/Credit_Debit_card/Card_number'), 'value')

input_card_number = input_card_number.replaceAll('\\D+', '')

System.out.println(input_card_number)
...
card_number = WebUI.getText(findTestObject('checkout/Issuing_Bank/card_number'))

card_number = card_number.replaceAll('\\D+', '')

System.out.println(card_number)

WebUI.verifyEqual(input_card_number, card_number)
