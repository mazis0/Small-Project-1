...
WebUI.click(findTestObject('checkout/Select_payment/back_button'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('checkout/Order_Summary/Order_Summary'), 0)
