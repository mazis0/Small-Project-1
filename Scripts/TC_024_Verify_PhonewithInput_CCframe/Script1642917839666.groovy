...
input_phone = WebUI.getAttribute(findTestObject('checkout/Form/Customer_Details/phone'), 'value')
...
WebUI.scrollToElement(findTestObject('checkout/Credit_Debit_card/email'), 0)

phone = WebUI.getAttribute(findTestObject('checkout/Credit_Debit_card/phone_number'), 'value')

System.out.println(phone)

if(input_phone.substring(0,1) == "0") {
	
	input_phone = input_phone.substring(1)
	
	input_phone = ("+62"+input_phone)
	
	System.out.println(input_phone)
}

WebUI.verifyEqual(input_phone, phone)
