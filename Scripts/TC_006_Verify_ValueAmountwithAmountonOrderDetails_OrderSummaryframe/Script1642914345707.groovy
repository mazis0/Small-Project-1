...
amount_ordersummary = WebUI.getText(findTestObject('checkout/Order_Summary/amount'))

amount_ordersummary = amount_ordersummary.replaceAll('\\D+', '')

int new_amount_ordersummary = Integer.parseInt(amount_ordersummary)

System.out.println(new_amount_ordersummary)

amount_orderdetails = WebUI.getText(findTestObject('checkout/Order_Summary/Order_details/amount'))

amount_orderdetails = amount_orderdetails.replaceAll('\\D+', '')

int new_amount_orderdetails = Integer.parseInt(amount_orderdetails)

System.out.println(new_amount_orderdetails)

WebUI.verifyEqual(new_amount_ordersummary, new_amount_orderdetails)
