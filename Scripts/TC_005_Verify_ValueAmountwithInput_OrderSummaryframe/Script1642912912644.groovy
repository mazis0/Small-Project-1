...
String midtrans_price = findTestData('Data_Input_Positive_Case').getValue(2, 2)

System.out.println(midtrans_price)
...
WebUI.verifyEqual(midtrans_price, new_amount_ordersummary)
