...
input_address = WebUI.getAttribute(findTestObject('checkout/Form/Customer_Details/address'), 'value')

input_city = WebUI.getAttribute(findTestObject('checkout/Form/Customer_Details/City'), 'value')

input_postal_code = WebUI.getAttribute(findTestObject('checkout/Form/Customer_Details/postal_code'), 'value')
...
address_shippingdetails = WebUI.getText(findTestObject('checkout/Order_Summary/Shipping_details/address'))

System.out.println(address_shippingdetails)

String new_address = input_address + ' ' + input_city + ' ' + input_postal_code

System.out.println(new_address)

WebUI.verifyEqual(new_address, address_shippingdetails)
