...
WebUI.setText(findTestObject('checkout/Issuing_Bank/password'), findTestData('Data_Input_Positive_Case').getValue(2, 15))

WebUI.click(findTestObject('checkout/Issuing_Bank/OK_button'))

WebUI.verifyElementPresent(findTestObject('HomePage/Success_transaction'), 0)
