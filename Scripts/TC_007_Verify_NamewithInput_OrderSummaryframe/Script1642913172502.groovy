...
input_name = WebUI.getAttribute(findTestObject('checkout/Form/Customer_Details/name'), 'value')
...
name_shippingdetails = WebUI.getText(findTestObject('checkout/Order_Summary/Shipping_details/name'))

System.out.println(name_shippingdetails)

WebUI.verifyEqual(input_name, name_shippingdetails)
